  ...
  imports: [
    ...
    JwtModule.forRoot({
      config: {
        ...
        whitelistedDomains: ['localhost:8090'], //['165.227.89.201'], //['localhost:8080'],
        blacklistedRoutes: ['http://localhost:8090/oauth/token']//['http://165.227.89.201/oauth/token'] //['http://localhost:8080/oauth/token']
      }
    })
  ],
  providers: [
